...
<form action="{{ route('leverancier.store') }}" method="post" class="space-y-6 bg-white p-6 rounded shadow-md max-w-md mx-auto">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" id="contact_persoon" name="contact_persoon" value="{{ old('contact_persoon') }}"
               class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('contactpersoon') border-red-500 @enderror">
    ...
    <div class="form-group">
        ...
        <textarea id="opmerking" name="opmerking" rows="3"
                  class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('opmerking') border-red-500 @enderror">{{ old('opmerking') }}</textarea>
        @error('opmerking')
        <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
        @enderror
    </div>
